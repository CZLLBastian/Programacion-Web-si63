...
public class UniversidadController {
	...
	public String preUpdate(Universidad u) {
		this.setU(u);
		return "modificacion2.xhtml";
	}
	...
	public void update() {
		try {
			...
			System.out.println("Error al modificar en el controller Universidad");
		}
	}
	
	public void findByNameUniversidad() {
		try {
			listaUniversidades=uService.findByNameUniversidad(this.getU());
		} catch (Exception e) {
			System.out.println("Error al buscar vacuna en el controlador Universidad");
		}
	}
